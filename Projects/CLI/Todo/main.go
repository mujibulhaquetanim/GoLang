...
func main() {
	...
	fmt.Println("To use other commands, please type `./todo-cli -help`")
	fmt.Printf("\n")
	fmt.Println("For more information, visit: https://github.com/mujibulhaquetanim/GoLang/tree/main/Projects/CLI/Todo")
